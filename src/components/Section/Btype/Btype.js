    ...
    <>
      <div className={cx('btype')}>
        ...
        <div className={cx("title-wrap", "global")}>
          ...
          <p className={cx('desc')}>입문부터 초급, 중급인 학생에게 추천해요. <br className={cx('')} /> 영어 사용국 튜터와 학습할 수 있어요.</p>
        </div>
        ...
        <div className={cx("title-wrap", "global")}>
          ...
          <p className={cx('desc')}>중급이상의 학생에게 추천드려요. <br className={cx('')} /> 영어가 모국어인 원어민 튜터와 학습해요.</p>
        </div>
      </div>
    </>
  )
